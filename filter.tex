...
\begin{abstract}
In this paper we present a method to estimate heat demand of residential
...
under estimate heat demand of the single buildings in the selected urban areas,
...
identification of ``hot spots'' in small urban areas is possible and (4) for a
...
support the ressources demand of the individual buildings is a challenge for both: urban
...
approach to classify the building stock intop building types for the estimation of heat demand.\\
...
The use of building typologies is used to estimate the impact of different retrofit scenarios
...
estimating the climate change mitigation potential and vulnerability of the residential
...
such databases by automatically classifying the building stock into building typologies.\\
...
VDI~3807~\cite{VDI-3807.1994}. Not only for heat demand a simulation at a low
